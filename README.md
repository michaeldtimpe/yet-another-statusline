...
```
~/Downloads/yet-another-statusline · git main/90db263 ✓ · ctx 84% 844.1K/1.0M · cache 157.6M · 18.0K/m · 5h 20% T-1:05 · 7d 32% · plan · start 25-may-26 · last 13:14 · Opus 4.7 1M xhigh
```
...
| `start DD-mon-YY · last HH:MM` | session opened (date) and last refresh (this render's clock time) |
